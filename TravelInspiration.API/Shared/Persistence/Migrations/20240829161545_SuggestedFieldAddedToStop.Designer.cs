...
namespace TravelInspiration.API.Shared.Persistence.Migrations
{
    ...
    [Migration("20240829161545_SuggestedFieldAddedToStop")]
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 29, 16, 15, 44, 602, DateTimeKind.Utc).AddTicks(3520),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 29, 16, 15, 44, 602, DateTimeKind.Utc).AddTicks(3524),
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Stop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 29, 16, 15, 44, 602, DateTimeKind.Utc).AddTicks(3801),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 29, 16, 15, 44, 602, DateTimeKind.Utc).AddTicks(3807),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 29, 16, 15, 44, 602, DateTimeKind.Utc).AddTicks(3810),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 29, 16, 15, 44, 602, DateTimeKind.Utc).AddTicks(3813),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 29, 16, 15, 44, 602, DateTimeKind.Utc).AddTicks(3819),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 29, 16, 15, 44, 602, DateTimeKind.Utc).AddTicks(3822),
